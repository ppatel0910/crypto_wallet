...
###############################################################################
# You will assume the perspective of a KryptoJobs2Go
...
# * Review the transaction hash code associated with the validated blockchain 
# transaction.

# Once you receive the transaction’s hash code, you will navigate to the 
# Transactions section of Ganache to review the blockchain transaction details. 
...
# 2. Add your mnemonic seed phrase (provided by Ganache) to the starter code’s 
# `SAMPLE.env` file. When the information has been added, rename 
# the file `.env`.
...
# Database of KryptoJobs2Go candidates including their name, digital address, 
#rating and hourly cost per Ether.
...
# the value of the `hours` variable. Save this calculation’s output as a
# variable named `wage`.
# * Write the `wage` variable to the Streamlit sidebar by using
# `st.sidebar.write`.
